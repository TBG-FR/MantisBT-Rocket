...
<?php echo form_security_field( 'plugin_Rocket_config' ) ?>
...
<table class="table table-bordered table-condensed table-striped">
    ...
    <tr>
      ...
      <td colspan="2">
        <p>
          Specifies the bug fields that should be attached to the RocketChat notifications.
        </p>
        <p>
          Option name is <strong>plugin_Rocket_columns</strong> and is an array of bug column names.
          Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
          <?php
